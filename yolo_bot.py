...
if __name__ == "__main__":
    ...
    labelsPath = os.path.sep.join([args["yolo"], "cone.names"])
    ...
    weightsPath = os.path.sep.join([args["yolo"], "yolov4-tiny-cones_best.weights"])
    configPath = os.path.sep.join([args["yolo"], "yolov4-tiny-cones.cfg"])

    # load our YOLO object detector trained on COCO dataset (80 classes)
    print("[INFO] loading YOLO from disk...")
    net = cv2.dnn.readNetFromDarknet(configPath, weightsPath)
    # lines to run inference on GPU with CUDA. Needs opencv build with CUDA
